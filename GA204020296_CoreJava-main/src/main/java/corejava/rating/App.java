...
public class App
{
	...
	public static void main( String[] args )
	{
		...
		Assignments assignments1 = new Assignments("Garima", "Electro Fields", "test", "5-Oct-22", 100);
		validateAssignmentCategory(assignments1);
		Assignments assignments2 = new Assignments("Devesh","Electro Fields", "test", "5-Oct-22", 78);
		validateAssignmentCategory(assignments2);
		Assignments assignment3 = new Assignments("Chaya", "Electro Fields","test", "5-Oct-22",68);
		validateAssignmentCategory(assignment3);
		Assignments assignment4 = new Assignments("Esharath","Electro Fields", "test", "5-Oct-22", 87);
		validateAssignmentCategory(assignment4);
		Assignments assignment5 = new Assignments("Devesh","Electro Fields", "quiz",  "5-Oct-22", 90);
		validateAssignmentCategory(assignment5);
		Assignments assignment6 = new Assignments("Chaya","Electro Fields", "lab",  "5-Oct-22", 10);
		validateAssignmentCategory(assignment6);
		Assignments assignment7 = new Assignments("Garima","Electro Fields", "project",  "5-Oct-22", 100);
		validateAssignmentCategory(assignment7);
		Assignments assignment8 = new Assignments("Esharath","Electro Fields", "project",  "5-Oct-22", 100);
		validateAssignmentCategory(assignment8);
		Assignments assignment9 = new Assignments("Devesh","Electro Fields", "quiz",  "5-Oct-22", 80);
		validateAssignmentCategory(assignment9);
		Assignments assignment10 = new Assignments("Garima","Electro Fields", "quiz", "5-Oct-22", 100);
		validateAssignmentCategory(assignment10);
		Assignments assignment11 = new Assignments("Devesh","Electro Fields", "lab",  "5-Oct-22", 10);
		validateAssignmentCategory(assignment11);
		Assignments assignment12 = new Assignments("Chaya","Electro Fields", "project",  "7-Oct-22", 100);
		validateAssignmentCategory(assignment12);
		Assignments assignment13 = new Assignments("Devesh","Electro Fields", "project",  "8-Oct-22", 100);
		validateAssignmentCategory(assignment13);
		Assignments assignment14 = new Assignments("Garima","Computing Techniques", "test", "5-Oct-22", 86);
		validateAssignmentCategory(assignment14);
		Assignments assignment15 = new Assignments("Garima","Electro Fields", "quiz",  "24-Oct-22", 100);
		validateAssignmentCategory(assignment15);
		Assignments assignment16 = new Assignments("Devesh","Computing Techniques", "project",  "5-Oct-22", 100);
		validateAssignmentCategory(assignment16);
		Assignments assignment17 = new Assignments("Garima","Electro Fields", "lab",  "21-Oct-22", 100);
		validateAssignmentCategory(assignment17);
		Assignments assignment18 = new Assignments("Chaya","Computing Techniques", "quiz", "5-Oct-22", 20);
		validateAssignmentCategory(assignment18);
		Assignments assignment19 = new Assignments("Garima","Electro Fields", "test", "5-Oct-22", 100);
		validateAssignmentCategory(assignment19);
		Assignments assignment20 = new Assignments("Chaya","Electro Fields", "test",  "10-Oct-22", 92);
		...
		while(choice != 6) {
			...
			case 4:
				...
				while(ch != 3) {
					...
					System.out.println("Press 2. Remove Category");
					...
					case 1:
						...
						System.out.println("Enter date of submission (DD-Month-YY): ");
						String date = sc.next();
						System.out.println("Please enter assignment category marks: ");
						int marks = sc.nextInt();
						addAssignmentCategory(name, subject, assigncategory, date, marks);
						break;

					case 2:
						System.out.println("Please enter name of the student to remove category: ");
